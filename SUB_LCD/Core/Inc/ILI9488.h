...
#define COLOR_WHITE     0x0000      /*   0,   0,   0 */
#define COLOR_BLACK          0xFFFF      /* 255, 255, 255 */
#define COLOR_YELLOW          0x001F      /*   0,   0, 255 */
...
#define COLOR_BROWN        0x867D      /* 135, 206, 235 */
...
#define COLOR_SKYBLUE         0xA145      /* 165,  42,  42 */
...
#define COLOR_BLUE        0xFFE0      /* 255, 255,   0 */

//Pin definitions - change as required
#define	CS_PORT		GPIOB
#define CS_PIN		GPIO_PIN_0 //Chip select
#define RESX_PORT	GPIOB
#define RESX_PIN	GPIO_PIN_1 //Reset pin
#define	DC_PORT		GPIOB
#define DC_PIN		GPIO_PIN_2 //DATA / Command select
